-- ============================================================================
-- RLS Test: public.influencer_rejections
...
-- Run: psql -f supabase/tests/rls/influencer_rejections.sql · OR Supabase SQL Editor
-- Pre-flight: migration 202604300001_rls_multi_tenant_influencer_rejections.sql applied
...
BEGIN
  SELECT COUNT(*) INTO visible_count FROM public.influencer_rejections;
  SELECT COUNT(*) INTO cross_tenant_visible FROM public.influencer_rejections
...
BEGIN
  SELECT COUNT(*) INTO client_a_visible FROM public.influencer_rejections
    WHERE client_id = ('sandbox-client-a');
...
DECLARE
  total_rows integer;
BEGIN
  SELECT COUNT(*) INTO total_rows FROM public.influencer_rejections;
...
DECLARE
  anon_count integer;
BEGIN
  SELECT COUNT(*) INTO anon_count FROM public.influencer_rejections;
