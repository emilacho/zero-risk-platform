-- ============================================================================
-- RLS Test: public.email_sequences
...
-- Run: psql -f supabase/tests/rls/email_sequences.sql · OR Supabase SQL Editor
-- Pre-flight: migration 202604300001_rls_multi_tenant_email_sequences.sql applied
...
BEGIN
  SELECT COUNT(*) INTO visible_count FROM public.email_sequences;
  SELECT COUNT(*) INTO cross_tenant_visible FROM public.email_sequences
...
BEGIN
  SELECT COUNT(*) INTO client_a_visible FROM public.email_sequences
    WHERE client_id = ('sandbox-client-a');
...
DECLARE
  total_rows integer;
BEGIN
  SELECT COUNT(*) INTO total_rows FROM public.email_sequences;
...
DECLARE
  anon_count integer;
BEGIN
  SELECT COUNT(*) INTO anon_count FROM public.email_sequences;
