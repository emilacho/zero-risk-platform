-- ============================================================================
-- RLS Test: public.content_fetch_cache
...
-- Run: psql -f supabase/tests/rls/content_fetch_cache.sql · OR Supabase SQL Editor
-- Pre-flight: migration 202604300001_rls_multi_tenant_content_fetch_cache.sql applied
...
BEGIN
  SELECT COUNT(*) INTO visible_count FROM public.content_fetch_cache;
  SELECT COUNT(*) INTO cross_tenant_visible FROM public.content_fetch_cache
...
BEGIN
  SELECT COUNT(*) INTO client_a_visible FROM public.content_fetch_cache
    WHERE client_id = ('sandbox-client-a');
...
DECLARE
  total_rows integer;
BEGIN
  SELECT COUNT(*) INTO total_rows FROM public.content_fetch_cache;
...
DECLARE
  anon_count integer;
BEGIN
  SELECT COUNT(*) INTO anon_count FROM public.content_fetch_cache;
