-- ============================================================================
-- RLS Test: public.client_brain_snapshots
...
-- Run: psql -f supabase/tests/rls/client_brain_snapshots.sql · OR Supabase SQL Editor
-- Pre-flight: migration 202604300001_rls_multi_tenant_client_brain_snapshots.sql applied
...
BEGIN
  SELECT COUNT(*) INTO visible_count FROM public.client_brain_snapshots;
  SELECT COUNT(*) INTO cross_tenant_visible FROM public.client_brain_snapshots
...
BEGIN
  SELECT COUNT(*) INTO client_a_visible FROM public.client_brain_snapshots
    WHERE client_id = ('sandbox-client-a');
...
DECLARE
  total_rows integer;
BEGIN
  SELECT COUNT(*) INTO total_rows FROM public.client_brain_snapshots;
...
DECLARE
  anon_count integer;
BEGIN
  SELECT COUNT(*) INTO anon_count FROM public.client_brain_snapshots;
