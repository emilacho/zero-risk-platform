-- ============================================================================
-- RLS Test: public.churn_predictions
...
-- Run: psql -f supabase/tests/rls/churn_predictions.sql · OR Supabase SQL Editor
-- Pre-flight: migration 202604300001_rls_multi_tenant_churn_predictions.sql applied
...
BEGIN
  SELECT COUNT(*) INTO visible_count FROM public.churn_predictions;
  SELECT COUNT(*) INTO cross_tenant_visible FROM public.churn_predictions
...
BEGIN
  SELECT COUNT(*) INTO client_a_visible FROM public.churn_predictions
    WHERE client_id = ('sandbox-client-a');
...
DECLARE
  total_rows integer;
BEGIN
  SELECT COUNT(*) INTO total_rows FROM public.churn_predictions;
...
DECLARE
  anon_count integer;
BEGIN
  SELECT COUNT(*) INTO anon_count FROM public.churn_predictions;
