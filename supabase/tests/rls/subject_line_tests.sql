-- ============================================================================
-- RLS Test: public.subject_line_tests
...
-- Run: psql -f supabase/tests/rls/subject_line_tests.sql · OR Supabase SQL Editor
-- Pre-flight: migration 202604300001_rls_multi_tenant_subject_line_tests.sql applied
...
BEGIN
  SELECT COUNT(*) INTO visible_count FROM public.subject_line_tests;
  SELECT COUNT(*) INTO cross_tenant_visible FROM public.subject_line_tests
...
BEGIN
  SELECT COUNT(*) INTO client_a_visible FROM public.subject_line_tests
    WHERE client_id = ('sandbox-client-a');
...
DECLARE
  total_rows integer;
BEGIN
  SELECT COUNT(*) INTO total_rows FROM public.subject_line_tests;
...
DECLARE
  anon_count integer;
BEGIN
  SELECT COUNT(*) INTO anon_count FROM public.subject_line_tests;
