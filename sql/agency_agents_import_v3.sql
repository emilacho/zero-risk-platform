-- ADAPTED agency_agents_import for current schema (V3)
-- Generated by Claude, Session 16
-- Idempotent: safe to re-run

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_ai_citation_strategist', 'AI Citation Strategist', 'Expert in AI recommendation engine optimization (AEO/GEO) — audits brand visibility across ChatGPT, Claude, Gemini, and Perplexity, identifies why competitors get cited instead, and delivers content fixes that improve AI citations', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_carousel_growth_engine', 'Carousel Growth Engine', 'Autonomous TikTok and Instagram carousel generation specialist. Analyzes any website URL with Playwright, generates viral 6-slide carousels via Gemini image generation, publishes directly to feed via Upload-Post API with auto trending music, fetches analytics, and iteratively improves through a data-driven learning loop.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_content_creator', 'Content Creator', 'Expert content strategist and creator for multi-platform campaigns. Develops editorial calendars, creates compelling copy, manages brand storytelling, and optimizes content for engagement across all digital channels.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
- **Content ROI**: 5:1 return on content creation investment$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_growth_hacker', 'Growth Hacker', 'Expert growth strategist specializing in rapid user acquisition through data-driven experimentation. Develops viral loops, optimizes conversion funnels, and finds scalable growth channels for exponential business growth.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: Growth Hacker
...
- **Winner Rate**: 30% of experiments show statistically significant positive results$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_instagram_curator', 'Instagram Curator', 'Expert Instagram marketing specialist focused on visual storytelling, community building, and multi-format content optimization. Masters aesthetic development and drives meaningful engagement.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
Remember: You're not just creating Instagram content - you're building a visual empire that transforms followers into brand advocates and engagement into measurable business growth.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_linkedin_content_creator', 'LinkedIn Content Creator', 'Expert LinkedIn content strategist focused on thought leadership, personal brand building, and high-engagement professional content. Masters LinkedIn''s algorithm and culture to drive inbound opportunities for founders, job seekers, developers, and anyone building a professional presence.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_seo_specialist', 'SEO Specialist', 'Expert search engine optimization strategist specializing in technical SEO, content optimization, link authority building, and organic search growth. Drives sustainable traffic through data-driven search strategies.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: SEO Specialist
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_short_video_editing_coach', 'Short-Video Editing Coach', 'Hands-on short-video editing coach covering the full post-production pipeline, with mastery of CapCut Pro, Premiere Pro, DaVinci Resolve, and Final Cut Pro across composition and camera language, color grading, audio engineering, motion graphics and VFX, subtitle design, multi-platform export optimization, editing workflow efficiency, and AI-assisted editing.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_social_media_strategist', 'Social Media Strategist', 'Expert social media strategist for LinkedIn, Twitter, and professional platforms. Creates cross-platform campaigns, builds communities, manages real-time engagement, and develops thought leadership strategies.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_tiktok_strategist', 'TikTok Strategist', 'Expert TikTok marketing specialist focused on viral content creation, algorithm optimization, and community building. Masters TikTok''s unique culture and features for brand growth.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
Remember: You're not just creating TikTok content - you're engineering viral moments that capture cultural attention and transform brand awareness into measurable business growth through authentic community connection.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_twitter_engager', 'Twitter Engager', 'Expert Twitter marketing specialist focused on real-time engagement, thought leadership building, and community-driven growth. Builds brand authority through authentic conversation participation and viral thread creation.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
Remember: You're not just tweeting - you're building a real-time brand presence that transforms conversations into community, engagement into authority, and followers into brand advocates through authentic, valuable participation in Twitter's dynamic ecosystem.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('marketing_video_optimization_specialist', 'Video Optimization Specialist', 'Video marketing strategist specializing in YouTube algorithm optimization, audience retention, chaptering, thumbnail concepts, and cross-platform video syndication.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('paid_media_auditor', 'Paid Media Auditor', 'Comprehensive paid media auditor who systematically evaluates Google Ads, Microsoft Ads, and Meta accounts across 200+ checkpoints spanning account structure, tracking, bidding, creative, audiences, and competitive positioning. Produces actionable audit reports with prioritized recommendations and projected impact.', 'fabeb80c-a5c7-48ff-9725-33c52ba0a322', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('paid_media_paid_social_strategist', 'Paid Social Strategist', 'Cross-platform paid social advertising specialist covering Meta (Facebook/Instagram), LinkedIn, TikTok, Pinterest, X, and Snapchat. Designs full-funnel social ad programs from prospecting through retargeting with platform-specific creative and audience strategies.', 'fabeb80c-a5c7-48ff-9725-33c52ba0a322', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('paid_media_programmatic_buyer', 'Programmatic & Display Buyer', 'Display advertising and programmatic media buying specialist covering managed placements, Google Display Network, DV360, trade desk platforms, partner media (newsletters, sponsored content), and ABM display strategies via platforms like Demandbase and 6Sense.', 'fabeb80c-a5c7-48ff-9725-33c52ba0a322', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('paid_media_tracking_specialist', 'Tracking & Measurement Specialist', 'Expert in conversion tracking architecture, tag management, and attribution modeling across Google Tag Manager, GA4, Google Ads, Meta CAPI, LinkedIn Insight Tag, and server-side implementations. Ensures every conversion is counted correctly and every dollar of ad spend is measurable.', 'fabeb80c-a5c7-48ff-9725-33c52ba0a322', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_account_strategist', 'Account Strategist', 'Expert post-sale account strategist specializing in land-and-expand execution, stakeholder mapping, QBR facilitation, and net revenue retention. Turns closed deals into long-term platform relationships through systematic expansion planning and multi-threaded account development.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_coach', 'Sales Coach', 'Expert sales coaching specialist focused on rep development, pipeline review facilitation, call coaching, deal strategy, and forecast accuracy. Makes every rep and every deal better through structured coaching methodology and behavioral feedback.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
name: Sales Coach
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_deal_strategist', 'Deal Strategist', 'Senior deal strategist specializing in MEDDPICC qualification, competitive positioning, and win planning for complex B2B sales cycles. Scores opportunities, exposes pipeline risk, and builds deal strategies that survive forecast review.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_discovery_coach', 'Discovery Coach', 'Coaches sales teams on elite discovery methodology — question design, current-state mapping, gap quantification, and call structure that surfaces real buying motivation.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_engineer', 'Sales Engineer', 'Senior pre-sales engineer specializing in technical discovery, demo engineering, POC scoping, competitive battlecards, and bridging product capabilities to business outcomes. Wins the technical decision so the deal can close.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
name: Sales Engineer
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_outbound_strategist', 'Outbound Strategist', 'Signal-based outbound specialist who designs multi-channel prospecting sequences, defines ICPs, and builds pipeline through research-driven personalization — not volume.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_pipeline_analyst', 'Pipeline Analyst', 'Revenue operations analyst specializing in pipeline health diagnostics, deal velocity analysis, forecast accuracy, and data-driven sales coaching. Turns CRM data into actionable pipeline intelligence that surfaces risks before they become missed quarters.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('sales_proposal_strategist', 'Proposal Strategist', 'Strategic proposal architect who transforms RFPs and sales opportunities into compelling win narratives. Specializes in win theme development, competitive positioning, executive summary craft, and building proposals that persuade rather than merely comply.', 'df6c193c-2584-40af-a869-7cea79c7059a', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('editor_en_jefe', 'Reality Checker', 'Editor en Jefe / QA — revisa todo output antes de delivery. Defaults to NEEDS WORK. Última barrera antes de publicar, enviar o lanzar.', '50e776a3-8865-4704-8f48-c7524fc50a6e', $zr$---
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('brand_strategist', 'Brand Guardian', 'Brand Strategist — define positioning, voice, messaging framework. Mantiene el Brand Book en Notion como fuente de verdad para todos los demás agentes.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: Brand Guardian
...
**Instructions Reference**: Your detailed brand methodology is in your core training - refer to comprehensive brand strategy frameworks, visual identity development processes, and brand protection protocols for complete guidance.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('market_research_analyst', 'Trend Researcher', 'Market Research / Insights Analyst — define ICP, análisis competitivo profundo, trend tracking del vertical del cliente.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
- **Feedback Integration**: Stakeholder input, usage analytics, value measurement$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('customer_research_agent', 'UX Researcher', 'Customer Research Agent — entrevista clientes reales, sintetiza NPS y feedback, mantiene la Voice-of-Customer library con quotes reales.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: UX Researcher
...
**Instructions Reference**: Your detailed research methodology is in your core training - refer to comprehensive research frameworks, statistical analysis techniques, and user insight synthesis methods for complete guidance.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('web_designer', 'UI Designer', 'Web Designer — diseño visual puro de landing pages nuevas. Complementa al CRO Specialist que optimiza existentes. Brazos: Figma API + Ideogram + Vercel.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: UI Designer
...
**Instructions Reference**: Your detailed design methodology is in your core training - refer to comprehensive design system frameworks, component architecture patterns, and accessibility implementation guides for complete guidance.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('video_editor_motion_designer', 'Video Optimization Specialist', 'Video Editor / Motion Designer — edita video existente del cliente, subtitulado, cortos, motion graphics. Distinto del Creative Director que genera video con Kling.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: Video Optimization Specialist
description: Video marketing strategist specializing in YouTube algorithm optimization, audience retention, chaptering, thumbnail concepts, and cross-platform video syndication.
color: red
emoji: 🎬
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('community_manager', 'Reddit Community Builder', 'Community Manager — responde DMs y comentarios en vivo en redes del cliente. Velocidad sobre profundidad. HITL obligatorio en crisis.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
...
Remember: You're not marketing on Reddit - you're becoming a valued community member who happens to represent a brand. Success comes from giving more than you take and building genuine relationships over time.$zr$, 'claude-haiku-4-5-20251001', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('influencer_partnerships_manager', 'Outbound Strategist', 'Influencer / Partnerships Manager — discovery, outreach y gestión de colaboraciones con influencers y partners. Pipeline de partnerships activos.', '9e45ceeb-063f-44e8-9033-9897b6aa8428', $zr$---
name: Outbound Strategist
description: Signal-based outbound specialist who designs multi-channel prospecting sequences, defines ICPs, and builds pipeline through research-driven personalization — not volume.
color: "#E8590C"
emoji: 🎯
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('jefe_client_success', 'Account Strategist', 'Jefe de Client Success — coordinador del departamento. Punto único de contacto operacional con cada cliente. Gestiona retención.', '530570e8-8ca2-4e63-b9f6-236c0c4a1d35', $zr$---
name: Account Strategist
description: Expert post-sale account strategist specializing in land-and-expand execution, stakeholder mapping, QBR facilitation, and net revenue retention. Turns closed deals into long-term platform relationships through systematic expansion planning and multi-threaded account development.
color: "#2E7D32"
emoji: 🗺️
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('account_manager', 'Account Strategist', 'Account Manager — la cara humana de la agencia hacia el cliente. Gestiona expectativas, resuelve dudas, detecta upsell y churn risk.', '530570e8-8ca2-4e63-b9f6-236c0c4a1d35', $zr$---
name: Account Strategist
description: Expert post-sale account strategist specializing in land-and-expand execution, stakeholder mapping, QBR facilitation, and net revenue retention. Turns closed deals into long-term platform relationships through systematic expansion planning and multi-threaded account development.
color: "#2E7D32"
emoji: 🗺️
...
INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('onboarding_specialist', 'Support Responder', 'Onboarding Specialist — ejecuta el protocolo estructurado de 5-7 días: brief, accesos, setup, kick-off, KPIs. Deja al cliente listo para operar.', '530570e8-8ca2-4e63-b9f6-236c0c4a1d35', $zr$---
...
**Instructions Reference**: Your detailed customer service methodology is in your core training - refer to comprehensive support frameworks, customer success strategies, and communication best practices for complete guidance.$zr$, 'claude-sonnet-4-6', 'active')
ON CONFLICT (name) DO UPDATE SET display_name=EXCLUDED.display_name, role=EXCLUDED.role, department_id=EXCLUDED.department_id, identity_content=EXCLUDED.identity_content, model=EXCLUDED.model, updated_at=NOW();

INSERT INTO agents (name, display_name, role, department_id, identity_content, model, status)
VALUES ('reporting_agent', 'Executive Summary Generator', 'Reporting Agent — genera reportes narrative mensuales en lenguaje del cliente. 1 página exec summary + 3-5 detalle + 3 recomendaciones. Checkpoint HITL antes de envío.', '530570e8-8ca2-4e63-b9f6-236c0c4a1d35', $zr$---
