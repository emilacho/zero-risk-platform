...
export async function GET(r: Request) { return handleReadStub(r, { name: 'analytics.engagement', makeResponse: makeEngagement }) }
export async function POST(r: Request) { return handleReadStub(r, { name: 'analytics.engagement', makeResponse: makeEngagement }) }
