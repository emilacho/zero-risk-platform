...
export async function GET(r: Request) { return handleReadStub(r, { name: 'analytics.nps', makeResponse: makeNps }) }
export async function POST(r: Request) { return handleReadStub(r, { name: 'analytics.nps', makeResponse: makeNps }) }
