...
export async function GET(r: Request) { return handleReadStub(r, { name: 'ghl.relationships', makeResponse: makeRelationships }) }
export async function POST(r: Request) { return handleReadStub(r, { name: 'ghl.relationships', makeResponse: makeRelationships }) }
